...
public class SmsMsOrdVO {
	...
	public String getDpstXchrCd() {
		return dpstXchrCd;
	}

	public void setDpstXchrCd(String dpstXchrCd) {
		this.dpstXchrCd = dpstXchrCd;
	}
	...
	public String toString() {
		return "SmsMsOrdVO [ordNo=" + ordNo + ", ordNm=" + ordNm
				...
				+ cnsXchrAmt + ", dpstXchrCd=" + dpstXchrCd + "]";
	}
