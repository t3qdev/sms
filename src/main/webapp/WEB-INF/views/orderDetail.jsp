	...
	<div class="ui-layout-single">
        <section>
            ...
            <div class="ui-layout-double">
               ...
               <a class="btn-proc btn_pop" id="btn_proc01" data-href="./orderPOView.do?ordNo=${ordNo }" data-popw="1900" data-poph="800">P/O确认</a>
